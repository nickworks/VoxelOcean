 ...
 SubShader {
	 // set a transparancey type
     Tags {"RenderType" = "Transparent" "Queue" = "Transparent"} 
     LOD 100 // set level of detail minimum
     
     ZWrite Off
     Blend SrcAlpha One // blending helps with transparancey
     ...
     Pass {  
         CGPROGRAM
             ...
             #include "classicNoise3d.cginc" // brings in the noise functions
