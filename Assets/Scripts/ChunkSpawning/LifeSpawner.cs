...
public class LifeSpawner : MonoBehaviour
{
    ...
    /// <summary>
    /// Prefab for bauble coral(Justin's coral).
    /// </summary>
    ...
    bool SpawnLifeAtVertex(int index, bool printDebug = false)
    {
        ...
        //if (biome.owner == BiomeOwner.Cameron) prefab = ;
        //if (biome.owner == BiomeOwner.Chris) prefab = ;
        //if (biome.owner == BiomeOwner.Dominic) prefab = ;
        //if (biome.owner == BiomeOwner.Eric) prefab = ;
        //if (biome.owner == BiomeOwner.Jess) prefab = ;
